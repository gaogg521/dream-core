...
impl TeamSessionService {
    ...
    pub(super) async fn build_agent_response(
        ...
        team_id: &str,
        agent: &TeamAgent,
    ) -> Result<dream_core_api_types::TeamAgentResponse, TeamError> {
    ...
    pub(super) async fn context_reset_capability(
        ...
        team_id: &str,
        agent: &TeamAgent,
    ) -> Result<dream_core_api_types::TeamContextResetCapability, TeamError> {
    ...
    pub(super) async fn context_reset_capability_for_session(
        ...
        use dream_core_api_types::{TeamContextResetAvailability as Availability, TeamContextResetCapability};
...
fn assistant_icon(assistant_id: &str, avatar_type: &str, avatar_value: Option<&str>) -> Option<String> {
    dream_core_api_types::assistant_avatar_response_value(avatar_type, avatar_value, assistant_id)
}
