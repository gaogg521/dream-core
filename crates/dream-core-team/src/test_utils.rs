...
use dream_core_db::models::{MailboxMessageRow, TeamRow, TeamTaskRow};
use dream_core_db::{ActivityCursor, DbError, ITeamRepository, PageDirection, UpdateTaskParams, UpdateTeamParams};
use std::sync::Mutex;
...
pub(crate) mod workspace_harness {
    ...
    use dream_core_common::{AgentKillReason, AgentType, PaginatedResult, now_ms};
    ...
    pub(crate) struct FullMockTeamRepo {
        ...
        messages: Mutex<Vec<dream_core_db::models::MailboxMessageRow>>,
    }
    ...
    impl ITeamRepository for FullMockTeamRepo {
        ...
        async fn update_task(
            ...
            _team_id: &str,
            _task_id: &str,
            _params: &dream_core_db::UpdateTaskParams,
        ) -> Result<(), DbError> {
            Ok(())
        }
    ...
    impl IWorkerTaskManager for NoopTaskManager {
        fn get_task(&self, _conversation_id: &str) -> Option<dream_core_ai_agent::AgentInstance> {
            None
        }
        ...
        async fn get_or_build_task(
            &self,
            _conversation_id: &str,
            _options: dream_core_ai_agent::types::BuildTaskOptions,
        ...
        fn collect_idle(&self, _idle_threshold_ms: dream_core_common::TimestampMs) -> Vec<String> {
            vec![]
        }
    }
    ...
    pub(crate) fn single_agent_team_request(name: &str) -> CreateTeamRequest {
        CreateTeamRequest {
            name: name.into(),
            agents: vec![dream_core_api_types::TeamAgentInput {
                name: "Lead".into(),
                role: "lead".into(),
