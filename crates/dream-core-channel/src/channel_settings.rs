...
impl ChannelSettingsService {
    ...
    async fn effective_assistant_backend(
        &self,
        user_id: &str,
        definition: &dream_core_db::models::AssistantDefinitionRow,
        overlays: &[dream_core_db::models::AssistantOverlayRow],
...
mod tests {
    ...
    use dream_core_db::{IAssistantDefinitionRepository, IAssistantOverlayRepository};
    use std::sync::Mutex;
