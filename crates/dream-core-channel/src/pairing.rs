...
use dream_core_api_types::{PairingRequestedPayload, UserAuthorizedPayload, WebSocketMessage};
use dream_core_common::{TimestampMs, generate_id, now_ms};
use dream_core_db::IChannelRepository;
use dream_core_db::models::{AssistantUserRow, PairingCodeRow};
...
mod tests {
    ...
    use dream_core_db::{DbError, IChannelRepository, UpdatePluginStatusParams};
    use std::sync::Mutex;
