...
mod weixin_tests {
    ...
    use dream_core_channel::manager::{ChannelManager, PluginFactory};
    use dream_core_channel::plugin::ChannelPlugin;
    use dream_core_channel::plugins::weixin::WeixinPlugin;
    use dream_core_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use dream_core_channel::plugins::weixin::weixin_login_stream;
