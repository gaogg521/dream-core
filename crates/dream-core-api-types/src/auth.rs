...
pub struct PublicUser {
    pub id: String,
    pub username: String,
    /// Set when the account's password was generated by the system rather
    /// than chosen by its owner (see `dream_core_db::models::User`'s same
    /// field). The client should route to a mandatory change-password screen
    /// while this is true instead of the normal app shell.
