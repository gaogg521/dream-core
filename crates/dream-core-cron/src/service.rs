...
impl CronService {
    ...
    async fn verify_conversation_helper_context(
        ...
        user_id: &str,
        conversation_id: &str,
    ) -> Result<dream_core_db::models::ConversationRow, CronError> {
        ...
        self.executor
            ...
            .await?
            .ok_or_else(|| {
                CronError::Conversation(dream_core_conversation::ConversationError::NotFound {
    ...
    async fn require_existing_conversation_scope(&self, user_id: &str, conversation_id: &str) -> Result<(), CronError> {
        if conversation_id.is_empty() {
            return Err(CronError::Conversation(
                dream_core_conversation::ConversationError::NotFound {
                    id: conversation_id.to_owned(),
                },
            ));
        }
    ...
    async fn build_agent_config_from_conversation(
        ...
        String,
        Option<dream_core_api_types::CronAgentConfigWriteDto>,
        Option<String>,
    ) {
        ...
        let agent_config = dream_core_api_types::CronAgentConfigWriteDto {
            name: assistant_name
    ...
    async fn build_cron_agent_config(
        ...
        config: dream_core_api_types::CronAgentConfigWriteDto,
...
impl dream_core_common::OnConversationDelete for CronService {
...
fn sanitize_agent_config_dto(
    mut config: dream_core_api_types::CronAgentConfigWriteDto,
...
mod tests {
    ...
    fn sanitize_agent_config_dto_clears_legacy_ids_when_assistant_id_present() {
        let config = dream_core_api_types::CronAgentConfigWriteDto {
            name: "Helper".into(),
            cli_path: None,
            assistant_id: Some("assistant-1".into()),
    ...
    fn sanitize_agent_config_dto_rejects_legacy_custom_agent_id_without_assistant_id() {
        let err = serde_json::from_value::<dream_core_api_types::CronAgentConfigWriteDto>(serde_json::json!({
            "name": "Helper",
