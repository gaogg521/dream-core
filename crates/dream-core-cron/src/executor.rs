...
use dream_core_api_types::{AssistantConversationRequest, CreateConversationRequest};
...
impl JobExecutor {
    ...
    pub async fn get_conversation_row(
        &self,
        conversation_id: &str,
    ) -> Result<Option<dream_core_db::models::ConversationRow>, CronError> {
    ...
    pub async fn get_assistant_snapshot(
        &self,
        conversation_id: &str,
    ) -> Result<Option<dream_core_db::models::ConversationAssistantSnapshotRow>, CronError> {
        let Some(user_id) = self
            .conversation_repo
            .owner_user_id(conversation_id)
            .await
...
mod tests {
    ...
    async fn hydrated_registry() -> Arc<AgentRegistry> {
        ...
        let repo = Arc::new(dream_core_db::SqliteAgentMetadataRepository::new(db.pool().clone()));
    ...
    fn make_executor_for_busy_tests() -> JobExecutor {
        ...
        impl IWorkerTaskManager for StubTaskManager {
            ...
            fn collect_idle(&self, _: dream_core_common::TimestampMs) -> Vec<String> {
                vec![]
            }
        }
        ...
        impl IConversationRepository for StubConvRepo {
            async fn get(
                ...
                _user_id: &str,
                _id: &str,
            ) -> Result<Option<dream_core_db::models::ConversationRow>, dream_core_db::DbError> {
                Ok(None)
            }
            ...
            ) -> Result<PaginatedResult<dream_core_db::models::ConversationRow>, dream_core_db::DbError> {
                Ok(PaginatedResult {
                    items: vec![],
                    total: 0,
                    has_more: false,
            ...
            async fn list_by_cron_job(
                ...
                _user_id: &str,
                _cron_job_id: &str,
            ) -> Result<Vec<dream_core_db::models::ConversationRow>, dream_core_db::DbError> {
                Ok(vec![])
            }
            ...
            ) -> Result<MessagePageResult, dream_core_db::DbError> {
            ...
            async fn insert_message(
                &self,
                _user_id: &str,
                _message: &dream_core_db::models::MessageRow,
            ) -> Result<(), dream_core_db::DbError> {
                Ok(())
            }
            ...
            async fn get_message_by_msg_id(
                ...
                _msg_id: &str,
                _msg_type: &str,
            ) -> Result<Option<dream_core_db::models::MessageRow>, dream_core_db::DbError> {
                Ok(None)
            }
            async fn search_messages(
                ...
                _page: u32,
                _page_size: u32,
            ) -> Result<PaginatedResult<MessageSearchRow>, dream_core_db::DbError> {
                Ok(PaginatedResult {
                    items: vec![],
                    total: 0,
                    has_more: false,
        ...
        impl dream_core_realtime::EventBroadcaster for StubBroadcaster {
            fn broadcast(&self, _: WebSocketMessage<serde_json::Value>) {}
        }

        struct StubSkillResolver;
        #[async_trait::async_trait]
        impl dream_core_conversation::skill_resolver::SkillResolver for StubSkillResolver {
            ...
            async fn resolve_skills(
                &self,
                _names: &[String],
            ) -> Vec<dream_core_conversation::skill_resolver::ResolvedAgentSkill> {
                Vec::new()
            }
            ...
            async fn link_workspace_skills(
                ...
                _rel_dirs: &[&str],
                _skills: &[dream_core_conversation::skill_resolver::ResolvedAgentSkill],
            ) -> usize {
                0
            }
        }

        let stub_broadcaster: Arc<dyn dream_core_realtime::EventBroadcaster> = Arc::new(StubBroadcaster);
        let stub_repo: Arc<dyn IConversationRepository> = Arc::new(StubConvRepo);
        let agent_metadata_repo: Arc<dyn dream_core_db::IAgentMetadataRepository> = Arc::new(StubAgentMetadataRepo);
        let acp_session_repo: Arc<dyn dream_core_db::IAcpSessionRepository> = Arc::new(StubAcpSessionRepo);
    ...
    impl IAgentTask for RecordingAgent {
        ...
        async fn cancel(&self) -> Result<(), dream_core_ai_agent::AgentError> {
            Ok(())
        }

        fn kill(&self, _reason: Option<AgentKillReason>) -> Result<(), dream_core_ai_agent::AgentError> {
            Ok(())
        }
    }
    ...
    impl IMockAgent for RecordingAgent {
        async fn mode(&self) -> Result<AgentModeResponse, dream_core_ai_agent::AgentError> {
        ...
        async fn set_config_option(
            ...
            option_id: &str,
            value: &str,
        ) -> Result<SetConfigOptionResponse, dream_core_ai_agent::AgentError> {
            if option_id != "mode" {
                return Err(dream_core_ai_agent::AgentError::bad_request(format!(
    ...
    impl IWorkerTaskManager for FailingTaskManager {
        ...
        async fn get_or_build_task(
            ...
            Err(dream_core_ai_agent::AgentError::bad_gateway(self.message.clone()))
        }
    ...
    impl IConversationRepository for ExistingConversationRepo {
        async fn get(
            ...
            Ok(Some(dream_core_db::models::ConversationRow {
                id: id.to_owned(),
                user_id: "user1".into(),
    ...
    struct MissingWorkspaceConversationRepo {
        ...
        inserted_messages: Mutex<Vec<dream_core_db::models::MessageRow>>,
    ...
    impl MissingWorkspaceConversationRepo {
        ...
        fn inserted_messages(&self) -> Vec<dream_core_db::models::MessageRow> {
    ...
    impl dream_core_realtime::EventBroadcaster for RecordingBroadcaster {
    ...
    impl IConversationRepository for MissingWorkspaceConversationRepo {
        ...
        async fn insert_message(
            &self,
            _user_id: &str,
            message: &dream_core_db::models::MessageRow,
        ) -> Result<(), dream_core_db::DbError> {
        ...
        ) -> Result<ConversationArtifactRow, dream_core_db::DbError> {
            self.operations
                .lock()
                .unwrap()
    ...
    fn make_executor_with_task_manager_and_repo(
        ...
        let broadcaster: Arc<dyn dream_core_realtime::EventBroadcaster> = Arc::new(StubBroadcaster);
    ...
    #[async_trait::async_trait]
    impl dream_core_db::IAcpSessionRepository for StubAcpSessionRepo {
        async fn get_for_user(
            &self,
            _user_id: &str,
            _conversation_id: &str,
        ) -> Result<Option<dream_core_db::models::AcpSessionRow>, dream_core_db::DbError> {
            Ok(None)
        }
        async fn create(
            &self,
            _params: &dream_core_db::CreateAcpSessionParams<'_>,
        ) -> Result<dream_core_db::models::AcpSessionRow, dream_core_db::DbError> {
            Err(dream_core_db::DbError::Init("stub".into()))
        }
        ...
        async fn load_runtime_state_for_user(
            ...
            _user_id: &str,
            _conversation_id: &str,
        ) -> Result<Option<dream_core_db::PersistedSessionState>, dream_core_db::DbError> {
            Ok(None)
        }
        async fn save_runtime_state_for_user(
            ...
            _user_id: &str,
            _conversation_id: &str,
            _params: &dream_core_db::SaveRuntimeStateParams<'_>,
        ) -> Result<bool, dream_core_db::DbError> {
            Ok(false)
        }
    }
    ...
    #[async_trait::async_trait]
    impl dream_core_db::IAgentMetadataRepository for StubAgentMetadataRepo {
        async fn list_all(&self) -> Result<Vec<dream_core_db::models::AgentMetadataRow>, dream_core_db::DbError> {
            Ok(Vec::new())
        }
        ...
        async fn upsert(
            &self,
            _params: &dream_core_db::models::UpsertAgentMetadataParams<'_>,
        ) -> Result<dream_core_db::models::AgentMetadataRow, dream_core_db::DbError> {
            Err(dream_core_db::DbError::Init("stub".into()))
        }
        async fn upsert_for_user(
            &self,
            _user_id: &str,
            params: &dream_core_db::models::UpsertAgentMetadataParams<'_>,
        ) -> Result<dream_core_db::models::AgentMetadataRow, dream_core_db::DbError> {
        ...
        async fn apply_handshake(
            &self,
            _id: &str,
            _params: &dream_core_db::models::UpdateAgentHandshakeParams<'_>,
        ) -> Result<Option<dream_core_db::models::AgentMetadataRow>, dream_core_db::DbError> {
            Ok(None)
        }
        async fn apply_handshake_for_user(
            ...
            _user_id: &str,
            id: &str,
            params: &dream_core_db::models::UpdateAgentHandshakeParams<'_>,
        ) -> Result<Option<dream_core_db::models::AgentMetadataRow>, dream_core_db::DbError> {
        ...
        async fn update_availability_snapshot(
            &self,
            _id: &str,
            _params: &dream_core_db::models::UpdateAgentAvailabilitySnapshotParams<'_>,
        ) -> Result<Option<dream_core_db::models::AgentMetadataRow>, dream_core_db::DbError> {
            Ok(None)
        }
        async fn update_availability_snapshot_for_user(
            ...
            _user_id: &str,
            id: &str,
            params: &dream_core_db::models::UpdateAgentAvailabilitySnapshotParams<'_>,
        ) -> Result<Option<dream_core_db::models::AgentMetadataRow>, dream_core_db::DbError> {
        ...
        async fn set_enabled(&self, _id: &str, _enabled: bool) -> Result<bool, dream_core_db::DbError> {
            Ok(false)
        }
        ...
        async fn delete(&self, _id: &str) -> Result<bool, dream_core_db::DbError> {
            Ok(false)
        }
        async fn delete_for_user(&self, _user_id: &str, id: &str) -> Result<bool, dream_core_db::DbError> {
