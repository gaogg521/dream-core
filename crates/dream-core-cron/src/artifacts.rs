...
mod tests {
    ...
    fn builds_skill_suggest_response() {
        ...
        assert_eq!(
            response.kind,
            dream_core_api_types::ConversationArtifactKind::SkillSuggest
        );
        assert_eq!(
            response.status,
            dream_core_api_types::ConversationArtifactStatus::Pending
        );
    ...
    fn builds_cron_trigger_payload() {
        ...
        assert_eq!(
            response.kind,
            dream_core_api_types::ConversationArtifactKind::CronTrigger
        );
