...
ALTER TABLE one_skill_registry ADD COLUMN origin TEXT NOT NULL DEFAULT 'self_built';
ALTER TABLE one_skill_registry ADD COLUMN category_id TEXT;
ALTER TABLE one_skill_registry ADD COLUMN published INTEGER NOT NULL DEFAULT 1;

ALTER TABLE one_mcp_registry ADD COLUMN origin TEXT NOT NULL DEFAULT 'self_built';
ALTER TABLE one_mcp_registry ADD COLUMN category_id TEXT;
ALTER TABLE one_mcp_registry ADD COLUMN published INTEGER NOT NULL DEFAULT 1;
