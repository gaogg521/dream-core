...
use dream_core_project::canonical::to_file_uri;
use dream_core_project::scm::{ScmActor, ScmInbound, ScmWirePush};
use dream_core_project::types::AttachInput;
...
// (same aliasing as `dream_core_common::validate_workspace_path_availability`).
#[cfg(not(windows))]
#[tokio::test]
