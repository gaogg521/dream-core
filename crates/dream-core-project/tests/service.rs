...
use dream_core_project::canonical::{canonicalize, to_file_uri};
use dream_core_project::types::{AttachInput, FileOp, ReferenceInput};
...
async fn a_case_variant_folder_resolves_to_one_repo_identity() {
    use dream_core_project::canonical::IGNORE_PATH_CASING;
