...
struct AgentMetadataSafeRow {
    ...
    last_check_at: Option<dream_core_common::TimestampMs>,
    last_success_at: Option<dream_core_common::TimestampMs>,
    last_failure_at: Option<dream_core_common::TimestampMs>,
    command_override: Option<String>,
    env_override: Option<String>,
    created_at: dream_core_common::TimestampMs,
    updated_at: dream_core_common::TimestampMs,
}
