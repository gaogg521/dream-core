...
impl IChannelRepository for SqliteChannelRepository {
    ...
    async fn update_user_last_active(
        ...
        owner_user_id: &str,
        id: &str,
        last_active: dream_core_common::TimestampMs,
    ) -> Result<(), DbError> {
    ...
    async fn update_session_activity(
        ...
        owner_user_id: &str,
        id: &str,
        last_activity: dream_core_common::TimestampMs,
    ) -> Result<(), DbError> {
    ...
    async fn cleanup_expired_pairings(
        &self,
        owner_user_id: &str,
        now: dream_core_common::TimestampMs,
    ) -> Result<u64, DbError> {
        let result = sqlx::query(
...
mod tests {
    ...
    async fn update_user_last_active_updates_timestamp() {
        ...
        let new_ts = dream_core_common::now_ms() + 5000;
