...
use dream_core_common::{PaginatedResult, TimestampMs};
    ...
    async fn copy_messages_up_to(
        ...
        let result: Result<u64, DbError> = async {
            ...
            for row in &rows {
                ...
                .bind(dream_core_common::generate_id())
...
mod tests {
    ...
    async fn initial_latest_returns_latest_limit_in_ascending_order() {
        ...
        for i in 0..10 {
            let mut msg = sample_message(&conv.id);
            msg.id = dream_core_common::generate_prefixed_id("msg");
    ...
    async fn search_messages_by_keyword() {
        ...
        msg2.id = dream_core_common::generate_prefixed_id("msg");
