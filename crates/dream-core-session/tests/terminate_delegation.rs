...
use dream_core_session::testing::CountingTerminateIo;
use dream_core_session::{AcpSessionBackend, ClaudeSessionBackend, CodexSessionBackend, SessionBackend};
...
async fn fake_agent_io_terminate_is_default_noop() {
    use dream_core_session::AgentIo;
    let io = dream_core_session::testing::FakeAgentIo::never_exits(Vec::new());
