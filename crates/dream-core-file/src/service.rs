...
use dream_core_api_types::{ContentEncoding, WebSocketMessage};
    ...
    async fn copy_files_to_workspace(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let mut fail = |fp: &str, reason: &str| {
                failed.push(dream_core_api_types::CopyFailure {
                    path: fp.to_owned(),
...
mod tests {
    ...
    impl dream_core_realtime::EventBroadcaster for NullBroadcaster {
