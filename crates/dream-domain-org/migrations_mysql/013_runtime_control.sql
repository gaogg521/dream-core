-- Runtime-node control plane (P1-7, align-openocta 智能体节点控制面) (MySQL port).
--
...
ALTER TABLE one_runtime_nodes ADD COLUMN status VARCHAR(16) NOT NULL DEFAULT 'approved';
ALTER TABLE one_runtime_nodes ADD COLUMN visibility VARCHAR(16) NOT NULL DEFAULT 'private';
