...
use dream_core_assistant::service::AssistantServiceDeps;
use dream_core_assistant::{AssistantService, BuiltinAssistantRegistry};
use dream_core_db::{
...
use dream_core_extension::{SkillPaths, fs_adopt};
