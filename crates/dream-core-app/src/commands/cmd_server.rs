...
use dream_core_api_types::{RuntimeStatusScope, RuntimeStatusScopeKind};
use dream_core_app::{AppConfig, AppServices, RouterBuildError, create_router_with_runtime};
use dream_core_system::RuntimePrepareService;
use dream_core_team::TeamIdleCleanupCoordinator;
...
pub(crate) async fn run_server(
    ...
    tokio::spawn(async move {
        ...
        let result = async {
            ...
            Ok::<(), dream_core_system::SystemError>(())
        }
        .await;
    ...
    let idle_cleanup_coordinator: Arc<dyn dream_core_ai_agent::IdleCleanupCoordinator> =
