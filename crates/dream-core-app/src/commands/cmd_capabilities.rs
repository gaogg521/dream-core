...
fn data() -> Value {
    json!({
        ...
        "purpose": "Top-level index for agent-facing One Work CLI domains.",
        "output": {
        ...
        "domains": [
            {
                "name": "config",
                "mode": "read-write",
                "description": "Manage One Work configuration: assistants, assistant rules, skills, MCP servers, providers, settings, agents, and scheduled tasks.",
            ...
            },
            {
                "name": "diagnose",
                "mode": "read-only",
                "description": "Diagnose a running One Work installation: backend health, conversations, provider health, MCP, cron, teams, logs, and controlled GET reads.",
