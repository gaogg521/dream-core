...
impl From<ManagedResourcesModeArg> for dream_core_runtime::ManagedResourcesMode {
...
pub(crate) enum Command {
    ...
    Capabilities,
    /// Agent-facing automation CLI for One Work configuration.
    Config(ConfigArgs),
    /// Agent-facing read-only troubleshooting CLI for One Work diagnosis.
