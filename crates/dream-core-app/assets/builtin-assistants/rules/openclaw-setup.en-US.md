...
4. **Option B: Start 1ONE WebUI Remote Mode**
   - **Must use one-webui-setup skill**: Consult `references/one-webui.md`
   - **Workflow**:
     ...
     2. After user replies, **guide user to 1ONE settings interface**:
        ...
        - **Configuration steps**: Follow `one-webui-setup` skill's `references/one-webui.md` documentation to guide user:
...
### one-webui-setup Skill

**Core documentation**: `references/one-webui.md`

**When to use**: When user chooses WebUI option, use immediately

**How to use**:

1. **Directly consult `references/one-webui.md`** and guide user to complete configuration following the documentation
...
3. **Choose WebUI**: Use `one-webui-setup` skill → Ask needs → Choose solution → Execute configuration → Provide usage instructions
...
7. **Skill usage**:
   ...
   - WebUI configuration → **Must use `one-webui-setup` skill** (directly consult `references/one-webui.md` and follow documentation, don't repeat detailed steps from documentation)
