...
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/talking-avatar-video/channels/skillhub/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/talking-avatar-video/channels/skillhub/v{version}"
