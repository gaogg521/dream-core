...
display_name: "创业可以学"
description: Q&A skill for entrepreneurs, managers, and business leaders. Triggers when users ask about。触发：用户提出「the-entrepreneurship-handbook」相关需求时使用（常见说法：the-entrepreneurship-handbook、the-entrepreneurship-handbook；英文：the/entrepreneurship/handbook）；不要用于“生成或编辑 Word/Excel/PPT 文档文件”（改用 officecli-docx / officecli-xlsx / officecli-pptx），也不要用于与本技能无关的其他任务。需要用户提供：明确的任务描述，以及必要的输入文件或数据。
---
