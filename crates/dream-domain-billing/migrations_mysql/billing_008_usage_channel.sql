...
-- used, recorded verbatim as `providers.id` (dream-core-db) (MySQL port).
-- Enterprise channels get a deterministic id derived from the registry
-- channel id — `prov_chan_<channel_id>`, see
...
ALTER TABLE one_usage_events ADD COLUMN channel_id VARCHAR(255) NULL;

CREATE INDEX idx_one_usage_events_channel
