-- T6: a mirror of the company's IdP directory (Feishu Contacts today) (MySQL port).
--
...
CREATE INDEX idx_one_directory_departments_parent
...
CREATE INDEX idx_one_directory_people_missing
...
CREATE TABLE IF NOT EXISTS one_directory_sync_state (
    enterprise_id     VARCHAR(255) PRIMARY KEY NOT NULL,
    ...
    external_id_field VARCHAR(64) NULL,
    ...
    department_count  BIGINT NOT NULL DEFAULT 0,
