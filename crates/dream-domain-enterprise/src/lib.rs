...
//! Dream Core fork — a user's real company (Feishu tenant_key etc.) + department
...
//! own tables. Populated at SSO login via a sync hook wired in dream-app.
...
//! only the route merge in dream-app and public dream-auth / dream-db APIs.
