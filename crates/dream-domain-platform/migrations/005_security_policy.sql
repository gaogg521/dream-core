...
CREATE TABLE IF NOT EXISTS one_security_policy (
    ...
    tier                                TEXT    NOT NULL DEFAULT 'relaxed',
    terminal_tools_require_approval     INTEGER NOT NULL DEFAULT 0,
    destructive_commands_blocked        INTEGER NOT NULL DEFAULT 0,
    ...
    external_network_denied_by_default  INTEGER NOT NULL DEFAULT 0,
    message_scan_enabled                INTEGER NOT NULL DEFAULT 0,
    message_redact_enabled              INTEGER NOT NULL DEFAULT 0,
