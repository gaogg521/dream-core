...
pub(super) async fn build(
    ...
    let hook_env = match deps.antigravity_hook_base_url.as_deref() {
        ...
        Some(base_url) => {
            ...
            vec![
                (
                    dream_core_api_types::AntigravityHookConfig::ENV_BASE_URL.to_owned(),
                    base_url.to_owned(),
                ),
                (dream_core_api_types::AntigravityHookConfig::ENV_TOKEN.to_owned(), token),
                (
                    dream_core_api_types::AntigravityHookConfig::ENV_CONVERSATION_ID.to_owned(),
