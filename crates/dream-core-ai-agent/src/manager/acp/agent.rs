...
impl AcpAgentManager {
    ...
    pub(crate) async fn mode(&self) -> Result<dream_core_api_types::AgentModeResponse, AgentError> {
        let desired = self
            .session
            .read()
            .await
...
impl crate::agent_task::IAgentTask for AcpAgentManager {
    ...
    fn supports_midturn_delivery(&self) -> bool {
        self.params
            ...
            .backend
            .as_deref()
            .is_some_and(dream_core_session::backend_supports_midturn_delivery)
    }
...
mod tests {
    ...
    use dream_core_common::{AgentKillReason, AgentType, ConversationStatus};
    use serde_json::json;
    use std::collections::HashMap;
    ...
    fn session_command_loading_preserves_empty_turn_meta() {
        ...
        assert_eq!(
            ...
            Some(dream_core_api_types::SlashCommandCompletionBehavior::NeutralTipOnEmpty)
        );
        assert_eq!(
    ...
    async fn register_failure_kills_spawned_process() {
        ...
        let process = Arc::new(
            CliAgentProcess::spawn_for_sdk(dream_core_common::CommandSpec {
