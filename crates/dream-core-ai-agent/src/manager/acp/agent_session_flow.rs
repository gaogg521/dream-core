...
use dream_core_api_types::SlashCommandItem;
...
impl AcpAgentManager {
    ...
    pub(super) async fn open_session_fork(&self, fork: &dream_core_api_types::ForkSpec) -> Result<String, AgentError> {
    ...
    async fn emit_snapshot_events(&self) {
        use dream_core_api_types::{ModelInfoEntry, ModelInfoPayload};
...
mod tests {
    ...
    use dream_core_api_types::{AgentErrorCode, SlashCommandCompletionBehavior, SlashCommandItem};
