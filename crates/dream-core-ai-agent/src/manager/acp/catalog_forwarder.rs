...
use dream_core_api_types::AgentHandshake;
use dream_core_common::normalize_keys_to_snake_case;
...
mod tests {
    ...
    fn probe_projection_matches_event_projection() {
        ...
        let model_payload = dream_core_api_types::ModelInfoPayload {
            current_model_id: Some("gpt-5".to_owned()),
            current_model_label: Some("GPT-5".to_owned()),
            available_models: vec![dream_core_api_types::ModelInfoEntry {
                id: "gpt-5".to_owned(),
