...
pub use dream_core_api_types::AgentStreamErrorData as ErrorEventData;
...
///
/// `phase` reuses the session layer's [`dream_core_session::MessageLifecyclePhase`]
...
/// without taking their own `dream-core-session` dependency.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
pub use dream_core_session::MessageLifecyclePhase;
