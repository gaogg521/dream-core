...
use dream_core_db::{IAcpSessionRepository, SaveRuntimeStateParams};
...
impl AcpSessionSyncService {
    ...
    pub async fn load_persisted(
        ...
        user_id: &str,
        conversation_id: &str,
    ) -> Option<dream_core_db::PersistedSessionState> {
...
mod tests {
    ...
    use dream_core_db::{CreateAcpSessionParams, SqliteAcpSessionRepository, init_database_memory};
