...
use dream_core_api_types::{ConversationArtifactResponse, ConversationResponse, MessageResponse, MessageSearchItem};
...
use dream_core_db::MessageSearchRow;
...
mod tests {
    use super::*;
    use dream_core_common::{AgentType, ConversationSource, ConversationStatus};
    use serde_json::json;
