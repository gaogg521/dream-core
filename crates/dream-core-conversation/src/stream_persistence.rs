...
use dream_core_api_types::{ConversationRuntimeSummary, WebSocketMessage};
use dream_core_common::{ErrorChain, normalize_keys_to_snake_case, now_ms};
use dream_core_db::models::MessageRow;
use dream_core_db::{ConversationRowUpdate, DbError, IConversationRepository, MessageRowUpdate};
...
impl StreamPersistenceAdapter {
    ...
    #[tracing::instrument(skip_all)]
    pub async fn persist_tool_call(&self, data: &dream_core_ai_agent::protocol::events::tool_call::ToolCallEventData) {
    ...
    pub async fn persist_acp_tool_call(
        &self,
        data: &dream_core_ai_agent::protocol::events::tool_call::AcpToolCallEventData,
    ) {
    ...
    pub async fn settle_tool_call_if_present(
        &self,
        data: &dream_core_ai_agent::protocol::events::tool_call::ToolCallEventData,
    ) -> bool {
        let existing = self
            .repo
