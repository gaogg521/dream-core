...
impl<'a> SessionContextBuilder<'a> {
    ...
    async fn resolve_acp_identity(
        ...
        extra: &serde_json::Value,
        session_row: Option<&dream_core_db::models::AcpSessionRow>,
...
fn decode_persisted_session_state(state: dream_core_db::PersistedSessionState) -> PersistedSessionState {
