...
use dream_core_ai_agent::{AgentInstance, agent_task::IAgentTask, session_agent::SessionAgentTask};
use dream_core_api_types::ConversationRuntimeStateKind;
use dream_core_common::{AgentKillReason, AgentType, now_ms};
...
async fn setup_repo() -> (Arc<SqliteConversationRepository>, dream_core_db::Database) {
