...
-- (migration 006) — neither of those changes. (MySQL port)
ALTER TABLE one_personal_agents ADD COLUMN origin VARCHAR(16) NOT NULL DEFAULT 'self_built';
ALTER TABLE one_personal_agents ADD COLUMN category_id VARCHAR(255) NULL;
ALTER TABLE one_personal_agents ADD COLUMN published TINYINT(1) NOT NULL DEFAULT 1;
