...
//!
//! These test the public API surface of `dream_core_extension::manifest`.

use dream_core_extension::{ExtensionError, ExtensionManifest, parse_manifest, validate_manifest};
