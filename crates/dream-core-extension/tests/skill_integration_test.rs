...
//!
//! These tests exercise the public API surface of `dream_core_extension::skill_service`
//! and `dream_core_extension::external_paths` against the functional requirements in
