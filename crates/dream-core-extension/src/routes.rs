...
use dream_core_common::{ApiError, now_ms};
use serde_json::json;
...
impl From<ExtensionError> for ApiError {
    fn from(err: ExtensionError) -> Self {
        match err {
            ...
            ExtensionError::Db(dream_core_db::DbError::NotFound(msg)) => ApiError::NotFound(msg),
            ExtensionError::Db(dream_core_db::DbError::Conflict(msg)) => ApiError::Conflict(msg),
