...
use dream_core_api_types::{SystemSettingsResponse, UpdateSettingsRequest};
use dream_core_db::ISettingsRepository;
...
mod tests {
    ...
    use dream_core_db::{SqliteSettingsRepository, init_database_memory};
