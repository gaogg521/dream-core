...
use dream_core_api_types::{ClientPreferencesResponse, UpdateClientPreferencesRequest};
...
mod tests {
    ...
    use dream_core_db::{SqliteClientPreferenceRepository, init_database_memory};
    use serde_json::json;
    use std::io::Write;
