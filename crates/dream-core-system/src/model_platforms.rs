...
pub fn model_platform_presets() -> Vec<ModelPlatformPreset> {
    vec![
        ...
        preset(
            ...
            "PPIO",
            "custom",
            Some("https://api.ppinfra.com/v3/openai"),
            "ai-cloud/ppio.svg",
            None,
        ),
        preset(
        ...
        preset(
            ...
            "InfiniAI",
            "custom",
            Some("https://cloud.infini-ai.com/maas/v1"),
            "ai-cloud/infiniai.svg",
            None,
        ),
        preset(
            "Ctyun",
            "Ctyun",
            "custom",
            Some("https://wishub-x1.ctyun.cn/v1"),
            "ai-cloud/ctyun.svg",
            None,
        ),
        preset(
