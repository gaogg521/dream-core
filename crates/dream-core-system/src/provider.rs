...
use dream_core_api_types::{CreateProviderRequest, ProviderKeyStatus, ProviderResponse, UpdateProviderRequest};
use dream_core_common::{decrypt_string, encrypt_string};
use dream_core_db::{CreateProviderParams, IProviderRepository, UpdateProviderParams, models::Provider};
...
mod tests {
    ...
    use dream_core_db::{SqliteProviderRepository, init_database_memory};
    ...
    fn validate_create_bedrock_allows_empty_base_url_and_api_key() {
        let req = CreateProviderRequest {
            ...
            base_url: "".into(),
            api_key: "".into(),
            bedrock_config: Some(dream_core_api_types::BedrockConfig {
                auth_method: dream_core_api_types::BedrockAuthMethod::Profile,
